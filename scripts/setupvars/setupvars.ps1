...
$Env:OPENVINO_LIB_PATHS = "$Env:INTEL_OPENVINO_DIR/runtime/bin/intel64/Release;$Env:INTEL_OPENVINO_DIR/runtime/bin/intel64/Debug;$Env:INTEL_OPENVINO_DIR/runtime/bin/intel64/RelWithDebInfo;$Env:OPENVINO_LIB_PATHS"
